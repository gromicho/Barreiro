...
TRANSLATIONS['en'].update(
    {
        ...
        'step1_addresses': 'Addresses',
        'step2_cleanup_optional': 'Clean up (optional)',
        ...
        'step3_optimize': 'Optimize',
        'step4_results': 'Results',
...
TRANSLATIONS['nl'].update(
    {
        ...
        'step1_addresses': 'Adressen',
        'step2_cleanup_optional': 'Opschonen (optioneel)',
        ...
        'step3_optimize': 'Optimaliseren',
        'step4_results': 'Resultaten',
...
TRANSLATIONS['pt'].update(
    {
        ...
        'step1_addresses': 'Endereços',
        'step2_cleanup_optional': 'Limpeza (opcional)',
        ...
        'step3_optimize': 'Otimizar',
        'step4_results': 'Resultados',
